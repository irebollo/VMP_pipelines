...
preproc_reslice_data_folder='/mnt/slow_scratch/BIDS/derivatives/fmriprep/'
...
file_list = list_files(preproc_reslice_data_folder, "*task-rest_run-001_desc-confounds_timeseries.tsv*")


print("Contents of the directory:")
print(os.listdir(preproc_reslice_data_folder))
...
with open('/home/ignacio/vmp_pipelines_gastro/list_clean_subjects.txt', 'w') as file:
