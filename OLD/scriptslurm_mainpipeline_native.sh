#!/bin/bash  
#SBATCH --array=1-30 #specify how many times you want a job to run, we have a total of 7 array spaces
...
matlab -nodesktop -nosplash -r "C_Main_script_slurm_native($SLURM_ARRAY_TASK_ID)"
