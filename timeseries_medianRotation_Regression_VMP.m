...
plotDir = dataDir;
plotFilename = strcat(plotDir,'S_',sprintf('%.4d',subj_idx),'_',cfgMain.task,'_chancePLVRotationhistogram_3mm');
...
medianRotationFilename = [dataDir,'sub-',sprintf('%.4d',subj_idx),'_medianRotation3mm']; 
