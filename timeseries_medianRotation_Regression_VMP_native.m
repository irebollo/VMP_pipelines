...
plotDir = dataDir;
plotFilename = strcat(plotDir,'S_',sprintf('%.4d',subj_idx),'_',cfgMain.task,'_chancePLVRotationhistogram_Native');
...
BOLDPhasesTimeseriesFilename = [dataDir,'sub-',sprintf('%.4d',subj_idx),'_BOLD_Native_filtered_CSFREGRESSED_phases']; 
medianRotationFilename = [dataDir,'sub-',sprintf('%.4d',subj_idx),'_medianRotationNative']; 
